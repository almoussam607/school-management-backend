...
import com.project.schoolmanagment.entity.concretes.contactmessage.ContactMessage;
import com.project.schoolmanagment.exception.ConflictException;
import com.project.schoolmanagment.exception.ResourceNotFoundException;
import com.project.schoolmanagment.payload.mappers.ContactMessageMapper;
import com.project.schoolmanagment.payload.messages.SuccessMessage;
import com.project.schoolmanagment.payload.request.business.ContactMessageRequest;
import com.project.schoolmanagment.payload.request.business.ContactMessageUpdateRequest;
import com.project.schoolmanagment.payload.response.business.ContactMessageResponse;
import com.project.schoolmanagment.payload.response.business.ResponseMessage;
import com.project.schoolmanagment.repository.business.ContactMessageRepository;
...
public class ContactMessageService {
	...
	public ResponseMessage<ContactMessageResponse> save(ContactMessageRequest contactMessageRequest){
		...
		if(isSameMessageWithSameEmailForToday){
			throw new ConflictException(SuccessMessage.ALREADY_SEND_A_MESSAGE_TODAY);
		}
	...
	public List<ContactMessage>searchByDateBetween(String beginDateString, String endDateString){
		try {
			...
			throw new ConflictException(SuccessMessage.WRONG_DATE_FORMAT);
		}
	}
	...
	public String deleteById(Long id){
		...
		return SuccessMessage.CONTACT_MESSAGE_DELETED_SUCCESSFULLY;
	}
	...
	public List<ContactMessage>searchByTimeBetween(String startHourString, String startMinuteString,
		...
		try {
			...
			throw new ConflictException(SuccessMessage.WRONG_TIME_FORMAT);
		}
	}

	public ContactMessage getContactMessageById(Long id){
		return contactMessageRepository.findById(id).orElseThrow(
				()-> new ResourceNotFoundException(SuccessMessage.NOT_FOUND_MESSAGE));
